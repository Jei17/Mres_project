...
\begin{figure}[H]
	...
	\begin{figure}
		...
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{potADAMAM.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.3\textwidth}
			\includegraphics[width=\linewidth]{potADAJJA.pdf}
			\caption{POT estimation}
		\end{subfigure}%
		\begin{subfigure}{0.3\textwidth}
			\includegraphics[width=\linewidth]{QQadaJJAPOTshape.pdf}
			\caption{QQ plot,POT shape estimator}
		\end{subfigure}%
		\begin{subfigure}{0.3\textwidth}
			\includegraphics[width=\linewidth]{TPaQQadaJJA.pdf}
			\caption{TPa }
		\end{subfigure}%
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{trMLEadaSON.pdf}
			\caption{MLE estimation}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{trTestADASON.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{potADASON.pdf}
			\caption{POT estimation}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{TPaQQadaSON.pdf}
			\caption{TPa }
		\end{subfigure}%
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{endTadaSON.pdf}
			\caption{End point estimaton}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuanADASON.pdf}
			\caption{p=0.0001}
		\end{subfigure}
	\end{figure}
