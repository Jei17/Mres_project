...
\begin{figure}[H]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{monAveADA.png}
	...
	\begin{figure}
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstADAMAM.pdf}
			\caption{Shape estimation}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEadaMAM.pdf}
			\caption{ME plot}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeADAMAM.pdf}
			\caption{Shape estimation}
		\end{subfigure}
	\caption{MAM}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot50ADAMAM.pdf}
			\caption{POT estimation $\xi = -0.08$}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuanADAMAM.pdf}
	...
	\begin{figure}[H]
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstADAJJA.pdf}
			\caption{Shape estimation}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEadaJJA.pdf}
			\caption{ME plot}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeADAJJA.pdf}
			\caption{Shape estimation}
		\end{subfigure}
		\caption{JJA}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot50ADAJJA.pdf}
			\caption{POT estimation, $\xi = 0.153$}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{QQGFadaJJA.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{endTadaJJA.pdf}
			\caption{End point estimaton}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuanADAJJA.pdf}
			\caption{Quantile estimation}
		\end{subfigure}
	\caption{JJA}
	\end{figure}
	...
	\begin{figure}[H]
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstADASON.pdf}
			\caption{Shape estimation}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEadaSON.pdf}
			\caption{ME plot}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeADASON.pdf}
			\caption{Shape estimation}
		\end{subfigure}
		\caption{SON}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot40ADASON.pdf}
			\caption{40 points,$\xi = -0.06$}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot45ADASON.pdf}
	...
	\end{figure}
		...
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuan40ADASON.pdf}
			\caption{40 points}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuan45ADASON.pdf}
			\caption{45 points}
		\end{subfigure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{monAveHO.png}
		\caption{Monthly averages}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstHOMAM.pdf}
			\caption{Shape estimation, MAM}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEhoMAM.pdf}
			\caption{ME plot, MAM}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeHOMAM.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{trMLEhoMAM.pdf}
			\caption{MLE estimation}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{trTestHOMAM.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot90HOMAM.pdf}
			\caption{POT $\xi = 0.006$, 90 extremes}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuanHOMAM.pdf}
			\caption{p=$10^{-5}$}
		\end{subfigure}
	\end{figure}
	...
	\begin{figure}[H]
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstHOJJA.pdf}
			\caption{Shape estimation, JJA}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEhoJJA.pdf}
			\caption{ME plot, JJA}
		\end{subfigure}%
			\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeHOJJA.pdf}
			\caption{Shape estimation, JJA}
		\end{subfigure}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot40HOJJA.pdf}
			\caption{POT $\xi = 0.04$, 40 extremes}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot60HOJJA.pdf}
			\caption{POT $\xi = -0.06$, 60 extremes}
		\end{subfigure}
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot100HOJJA.pdf}
			\caption{POT, $\xi = 0.05$, 100 extremes }
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{pot110HOJJA.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{exccHOJJA.pdf}
			\caption{100 largest values}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{extQuanHOJJA.pdf}
			\caption{p=$10^{-5}$}
		\end{subfigure}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shEstHOSON.pdf}
			\caption{Shape estimation, SON}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{MEhoSON.pdf}
			\caption{ME plot, SON}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{shapeHOSON.pdf}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{pot40HOSON.pdf}
			\caption{POT $\xi = 0.19$, 40 extremes}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{pot90HOSON.pdf}
			\caption{POT $\xi = 0.009$, 90 extremes}
		\end{subfigure}%
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{extQuanHOSON.pdf}
			\caption{p=$10^{-5}$}
		\end{subfigure}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{wgADAMAMme.pdf}
			\caption{ME plot}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{wgADAMAMshape.pdf}
			\caption{Shape estimation}
		\end{subfigure}
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{wgADAMAMpot.pdf}
			\caption{POT, $\xi =-0.57$}
		\end{subfigure}%
		\begin{subfigure}{0.5\textwidth}
			\includegraphics[width=\linewidth]{wgADAMAMq}
			\caption{Quantiles}
		\end{subfigure}
	\caption{Only gamma, no truncation}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.33\textwidth}
			\includegraphics[width=\linewidth]{wgADAMAMttNT.pdf}
